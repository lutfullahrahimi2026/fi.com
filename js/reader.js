(function () {
  ...
  if (!contentEl || !window.api) return;
  ...
  window.api
    .get(`/api/books/${encodeURIComponent(slug)}`)
    .then((book) => {
      ...
      if (book.pdfUrl) {
        contentEl.innerHTML = `
          ...
          <div style="margin-top: var(--space-md); display: flex; gap: 12px; flex-wrap: wrap;">
            <a href="https://www.amazon.com/" target="_blank" rel="noopener" class="btn btn-secondary">Buy</a>
